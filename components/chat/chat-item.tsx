...
const ChatItem = ({
  ...
  ">
      ...
      ">
        ...
        transition
        ">
          <UserAvatar src={member.user.image ? member.user.image : undefined} />
        </div>
        <div className="flex flex-col w-full">
            ...
            <div className="flex items-center">
              <Popover>
                ...
                <PopoverContent
                  side="top"
                  align="start"
                  className="w-full h-full  bg-[#1E1F22] shadow-md rounded-md z-10  focus:outline-none ">
                  <ProfilePopover user={member.user} />
                </PopoverContent>
              </Popover>
          ...
          {isImage && (
            <a
              ...
              h-48 
              w-48">
              <Image src={fileUrl} alt={content} fill className="object-cover z-[5]" />
            </a>
          )}
          {isPDF && (
            <div
